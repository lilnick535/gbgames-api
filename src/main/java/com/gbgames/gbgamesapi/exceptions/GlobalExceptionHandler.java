package com.gbgames.gbgamesapi.exceptions;

import java.util.Date;

import com.gbgames.gbgamesapi.GbgamesApiApplication;
...
public class GlobalExceptionHandler {
    private static final Logger logger = LogManager.getLogger(GbgamesApiApplication.class);        
