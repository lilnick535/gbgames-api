...
import com.gbgames.gbgamesapi.dto.request.LoginRequest;
import com.gbgames.gbgamesapi.dto.request.ResetPassword;
import com.gbgames.gbgamesapi.dto.request.SignupRequest;
import com.gbgames.gbgamesapi.dto.response.JwtResponse;
import com.gbgames.gbgamesapi.dto.response.MessageResponse;
...
import com.gbgames.gbgamesapi.repository.RoleRepo;
import com.gbgames.gbgamesapi.security.jwt.JwtUtils;
import com.gbgames.gbgamesapi.security.service.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (strRoles == null) {
			Role userRole = roleRepo.findByNome(EnumRole.MEMBRO)
			...
			strRoles.forEach(role -> {
				switch (role) {
					case "admin":
						Role adminRole = roleRepo.findByNome(EnumRole.ADMIN)
								.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
						roles.add(adminRole);
						break;
					default:
